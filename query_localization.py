    ...
    if has_ls:
        ...
        cells = [
            _cell(
                ...
                "aladin.add_graphic_overlay_from_region([region], color='rgba(255, 220, 0, 0.6)', linewidth=2)\n"
                "\n"
                "t_ls = Table.from_pandas(df_ls[['ra', 'dec', 'type', 'z_phot_mean', 'mag_r', 'mag_r_corr', 'offset_arcsec', 'P_cc']])\n"
                "aladin.add_table(t_ls, color='rgba(255, 100, 100, 0.65)', shape='circle')\n"
                "\n"
        ...
        cells = [
            _cell(
                ...
                "        aladin.add_table(Table.from_pandas(df[keep].fillna('')), color='rgba(100, 220, 100, 0.65)', shape='circle')\n"
                ...
                "        t_ned.rename_column('RA','ra'); t_ned.rename_column('DEC','dec')\n"
                "        aladin.add_table(t_ned, color='rgba(180, 100, 220, 0.65)', shape='circle')\n"
